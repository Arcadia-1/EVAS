...
_DEFAULT_OUT = HERE.parent.parent.parent / 'output' / 'dwa_ptr_gen'
...
def analyze(out_dir: Path = _DEFAULT_OUT) -> None:
    ...
    axes[0].set_title(f'dwa_ptr_gen (DWA pointer rotation)  |  wall clock: {wall_s:.4f} s')
